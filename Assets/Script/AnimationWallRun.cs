...
public class AnimationWallRun : MonoBehaviour
{
    ...
    AnimationCharacterController m_AnimationCharacterController;
    ...
    bool isPlayergrounded() => m_AnimationCharacterController.isGrounded;
    ...
    void Start()
    {
        m_AnimationCharacterController = GetComponent<AnimationCharacterController>();
    ...
    public void LateUpdate()
    {
        ...
        if (isWallRunning)
        {
            ...
            m_AnimationCharacterController.characterVelocity += Vector3.down * wallGravityDownForce * Time.deltaTime;
        }
        else
        {
    ...
    void OnWall(RaycastHit hit)
    {
        ...
        if (d >= -normalizedAngleThreshold && d <= normalizedAngleThreshold)
        {
            ...
            m_AnimationCharacterController.characterVelocity = alongWall * vertical * wallSpeedMultiplier;
            isWallRunning = true;
        }
    }
    ...
    public float GetCameraRoll()
    {
        ...
        //float cameraAngle = m_AnimationCharacterController.playerCamera.transform.eulerAngles.z;
        float targetAngle = 0;
        if (dir != 0)
        {
            targetAngle = Mathf.Sign(dir) * maxAngleRoll;
        }
        return Mathf.LerpAngle(0, targetAngle, (Mathf.Max(elapsedTimeSinceWallAttach, elapsedTimeSinceWallDetatch) * 2) /*cameraTransitionDuration*/);
    }
